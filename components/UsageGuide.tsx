    ...
    <section className="bg-background py-24 sm:py-32 px-4 sm:px-6 font-dmSans relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto space-y-16 relative z-10">
        ...
        >
          ...
          <h2 className="mt-4 text-4xl sm:text-5xl lg:text-6xl font-black text-foreground tracking-tighter uppercase leading-tight">
            ...
            >
              <div className="space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="block text-[10px] font-mono text-muted-foreground uppercase tracking-[0.3em]">
                      {s.step}
                    </span>
...
function ToolPreview() {
  ...
  return (
    <div className="space-y-2.5">
      <span className="text-[10px] font-mono text-muted-foreground uppercase tracking-[0.3em] block text-left">
        Toolkit
      </span>
      {tools.map((t) => (
        <div
...
function UploadPreview() {
  return (
    <div className="space-y-3.5 text-left">
      <span className="text-[10px] font-mono text-muted-foreground uppercase tracking-[0.3em] block">
        Subtitle File
      </span>
      <div className="flex items-center gap-2.5 rounded-xl border border-border/80 bg-background px-3 py-2.5">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-xs font-medium text-foreground truncate">the-odyssey.srt</p>
          <p className="text-[10px] font-mono text-muted-foreground">112.85 KB</p>
        </div>
    ...
    <div className="space-y-3 text-left">
      ...
      <div className="p-3 bg-background border border-border/80 rounded-xl space-y-2">
        <div className="flex justify-between items-center text-[11px]">
          <span className="text-muted-foreground font-mono">Target Format:</span>
          <span className="font-semibold text-primary uppercase font-mono text-[10px] bg-primary/10 px-1.5 py-0.5 rounded">.ASS</span>
        </div>
        <div className="flex justify-between items-center text-[11px]">
          <span className="text-muted-foreground font-mono">Preserve Style:</span>
  ...
  return (
    <div className="space-y-3.5 text-left">
      ...
      <div className="flex items-center gap-2.5 rounded-xl border border-primary/20 bg-primary/5 px-3 py-2.5">
        ...
        <span className="text-xs font-semibold text-foreground truncate">the-odyssey.ass</span>
      </div>
